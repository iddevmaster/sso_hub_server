...
Route::post('/data/add', [App\Http\Controllers\HomeController::class, 'addData'])->name('data.add')->middleware('admin');
Route::post('/data/update', [App\Http\Controllers\HomeController::class, 'updateData'])->name('data.update')->middleware('admin');
Route::post('/data/delete', [App\Http\Controllers\HomeController::class, 'deleteData'])->name('data.delete')->middleware('admin');
...
Route::post('/customer/import', [App\Http\Controllers\CustomerController::class, 'importData'])->name('importData')->middleware('admin');
