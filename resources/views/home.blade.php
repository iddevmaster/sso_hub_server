                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 container text-center">
                        <div class="row row-cols-sm-2 row-cols-md-4">
                            ...
                            <a href="http://checkbefore.trainingzenter.com/sso/{{ $user->username }}/{{ $user->name }}/{{ $course_type }}/{{ $send_branch ?? 'idmskk' }}" target="_BLANK" class="link-underline link-underline-opacity-0">
                                <div class="service p-2 rounded">
                                    <img src="/imgs/logoiddrives.png" width="50" alt="">
